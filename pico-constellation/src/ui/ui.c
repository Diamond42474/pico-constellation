...
#define HTML_CONTENT                                                             \
    ...
    "</div>"                                                                     \
    "<div class='card'>"                                                         \
    "<div class='label'>COUNT</div><div class='value'>%d</div>"                  \
    "</div>"                                                                     \
    "</body>"                                                                    \
    "</html>"
...
{
    static int count = 0;
    snprintf(contents->contents, HTML_MAX_CONTENTS, HTML_CONTENT, request->method, request->path, request->query, count++);
